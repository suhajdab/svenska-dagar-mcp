...
// ---------------------------------------------------------------------------
// Input validation — all bounds checked before any string interpolation.
// ---------------------------------------------------------------------------

function validateYear(year: unknown): asserts year is number {
...
function validateMonth(month: unknown): asserts month is number {
